...
const {noticeController, getNoticeController} = require('../controllers/notice');
const {feedbackController, getFeedbackController} = require('../controllers/feedback');
const {tournamentController, getTournamentController, deleteTournament}=require('../controllers/tournament');
const notice = require('../models/notice');
const {bookingController, getBookingController } = require('../controllers/booking');
// const {
